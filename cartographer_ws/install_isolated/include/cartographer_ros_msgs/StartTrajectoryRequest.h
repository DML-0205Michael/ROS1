...
struct StartTrajectoryRequest_
{
  ...
  (void)_alloc;
   ...
   typedef std::basic_string<char, std::char_traits<char>, typename std::allocator_traits<ContainerAllocator>::template rebind_alloc<char>> _configuration_directory_type;
  _configuration_directory_type configuration_directory;

   typedef std::basic_string<char, std::char_traits<char>, typename std::allocator_traits<ContainerAllocator>::template rebind_alloc<char>> _configuration_basename_type;
...
{
  return lhs.configuration_directory == rhs.configuration_directory &&
    lhs.configuration_basename == rhs.configuration_basename &&
    lhs.use_initial_pose == rhs.use_initial_pose &&
    lhs.initial_pose == rhs.initial_pose &&
    lhs.relative_to_trajectory_id == rhs.relative_to_trajectory_id;
}
...
struct Printer< ::cartographer_ros_msgs::StartTrajectoryRequest_<ContainerAllocator> >
{
  template<typename Stream> static void stream(Stream& s, const std::string& indent, const ::cartographer_ros_msgs::StartTrajectoryRequest_<ContainerAllocator>& v)
  {
    ...
    Printer<std::basic_string<char, std::char_traits<char>, typename std::allocator_traits<ContainerAllocator>::template rebind_alloc<char>>>::stream(s, indent + "  ", v.configuration_directory);
    s << indent << "configuration_basename: ";
    Printer<std::basic_string<char, std::char_traits<char>, typename std::allocator_traits<ContainerAllocator>::template rebind_alloc<char>>>::stream(s, indent + "  ", v.configuration_basename);
