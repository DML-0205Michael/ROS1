...
struct LandmarkList_
{
  ...
  _header_type header;
   ...
   typedef std::vector< ::cartographer_ros_msgs::LandmarkEntry_<ContainerAllocator> , typename std::allocator_traits<ContainerAllocator>::template rebind_alloc< ::cartographer_ros_msgs::LandmarkEntry_<ContainerAllocator> >> _landmarks_type;
...
bool operator==(const ::cartographer_ros_msgs::LandmarkList_<ContainerAllocator1> & lhs, const ::cartographer_ros_msgs::LandmarkList_<ContainerAllocator2> & rhs)
{
