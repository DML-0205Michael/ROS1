...
struct TrajectoryStates_
{
  ...
  _header_type header;
   ...
   typedef std::vector<int32_t, typename std::allocator_traits<ContainerAllocator>::template rebind_alloc<int32_t>> _trajectory_id_type;
  _trajectory_id_type trajectory_id;

   typedef std::vector<uint8_t, typename std::allocator_traits<ContainerAllocator>::template rebind_alloc<uint8_t>> _trajectory_state_type;
