...
struct SubmapQueryResponse_
{
  ...
  _submap_version_type submap_version;
   ...
   typedef std::vector< ::cartographer_ros_msgs::SubmapTexture_<ContainerAllocator> , typename std::allocator_traits<ContainerAllocator>::template rebind_alloc< ::cartographer_ros_msgs::SubmapTexture_<ContainerAllocator> >> _textures_type;
...
bool operator==(const ::cartographer_ros_msgs::SubmapQueryResponse_<ContainerAllocator1> & lhs, const ::cartographer_ros_msgs::SubmapQueryResponse_<ContainerAllocator2> & rhs)
{
