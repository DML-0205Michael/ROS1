...
bool operator==(const ::cartographer_ros_msgs::StartTrajectoryResponse_<ContainerAllocator1> & lhs, const ::cartographer_ros_msgs::StartTrajectoryResponse_<ContainerAllocator2> & rhs)
{
