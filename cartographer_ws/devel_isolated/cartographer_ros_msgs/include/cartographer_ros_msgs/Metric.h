...
struct Metric_
{
  ...
  _type_type type;
   ...
   typedef std::vector< ::cartographer_ros_msgs::MetricLabel_<ContainerAllocator> , typename std::allocator_traits<ContainerAllocator>::template rebind_alloc< ::cartographer_ros_msgs::MetricLabel_<ContainerAllocator> >> _labels_type;
  _labels_type labels;

   typedef double _value_type;
  _value_type value;

   typedef std::vector< ::cartographer_ros_msgs::HistogramBucket_<ContainerAllocator> , typename std::allocator_traits<ContainerAllocator>::template rebind_alloc< ::cartographer_ros_msgs::HistogramBucket_<ContainerAllocator> >> _counts_by_bucket_type;
