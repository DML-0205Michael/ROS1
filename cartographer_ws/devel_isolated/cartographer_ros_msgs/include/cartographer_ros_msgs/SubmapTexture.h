...
struct SubmapTexture_
{
  ...
  (void)_alloc;
   ...
   typedef std::vector<uint8_t, typename std::allocator_traits<ContainerAllocator>::template rebind_alloc<uint8_t>> _cells_type;
  _cells_type cells;
...
bool operator==(const ::cartographer_ros_msgs::SubmapTexture_<ContainerAllocator1> & lhs, const ::cartographer_ros_msgs::SubmapTexture_<ContainerAllocator2> & rhs)
{
