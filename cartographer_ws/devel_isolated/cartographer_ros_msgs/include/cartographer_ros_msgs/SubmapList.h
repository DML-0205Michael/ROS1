...
struct SubmapList_
{
  ...
  _header_type header;
   ...
   typedef std::vector< ::cartographer_ros_msgs::SubmapEntry_<ContainerAllocator> , typename std::allocator_traits<ContainerAllocator>::template rebind_alloc< ::cartographer_ros_msgs::SubmapEntry_<ContainerAllocator> >> _submap_type;
  _submap_type submap;
...
bool operator==(const ::cartographer_ros_msgs::SubmapList_<ContainerAllocator1> & lhs, const ::cartographer_ros_msgs::SubmapList_<ContainerAllocator2> & rhs)
{
