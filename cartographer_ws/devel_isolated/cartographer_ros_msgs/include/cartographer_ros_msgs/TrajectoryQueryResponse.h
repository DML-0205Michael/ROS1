...
struct TrajectoryQueryResponse_
{
  ...
  _status_type status;
   ...
   typedef std::vector< ::geometry_msgs::PoseStamped_<ContainerAllocator> , typename std::allocator_traits<ContainerAllocator>::template rebind_alloc< ::geometry_msgs::PoseStamped_<ContainerAllocator> >> _trajectory_type;
...
bool operator==(const ::cartographer_ros_msgs::TrajectoryQueryResponse_<ContainerAllocator1> & lhs, const ::cartographer_ros_msgs::TrajectoryQueryResponse_<ContainerAllocator2> & rhs)
{
