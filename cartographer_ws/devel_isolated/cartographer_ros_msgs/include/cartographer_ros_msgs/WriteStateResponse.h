...
bool operator==(const ::cartographer_ros_msgs::WriteStateResponse_<ContainerAllocator1> & lhs, const ::cartographer_ros_msgs::WriteStateResponse_<ContainerAllocator2> & rhs)
{
