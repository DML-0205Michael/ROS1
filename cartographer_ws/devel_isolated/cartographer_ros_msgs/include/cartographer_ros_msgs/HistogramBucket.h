...
bool operator==(const ::cartographer_ros_msgs::HistogramBucket_<ContainerAllocator1> & lhs, const ::cartographer_ros_msgs::HistogramBucket_<ContainerAllocator2> & rhs)
{
  return lhs.bucket_boundary == rhs.bucket_boundary &&
    lhs.count == rhs.count;
}
