...
static const ::google::protobuf::internal::MigrationSchema schemas[] GOOGLE_ATTRIBUTE_SECTION_VARIABLE(protodesc_cold) = {
  { 0, -1, sizeof(RangeDataInserterOptions3D)},
};

static ::google::protobuf::Message const * const file_default_instances[] = {
  reinterpret_cast<const ::google::protobuf::Message*>(&_RangeDataInserterOptions3D_default_instance_),
};
...
void TableStruct::InitDefaultsImpl() {
  ...
  _RangeDataInserterOptions3D_default_instance_._instance.DefaultConstruct();
...
RangeDataInserterOptions3D::RangeDataInserterOptions3D()
  ...
  if (GOOGLE_PREDICT_TRUE(this != internal_default_instance())) {
    protobuf_cartographer_2fmapping_2fproto_2frange_5fdata_5finserter_5foptions_5f3d_2eproto::InitDefaults();
  }
  SharedCtor();
