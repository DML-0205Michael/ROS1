...
void TableStruct::InitDefaultsImpl() {
  ...
  ::google::protobuf::internal::OnShutdownDestroyMessage(
      &_PoseExtrapolatorOptions_default_instance_);_ImuBasedPoseExtrapolatorOptions_default_instance_._instance.get_mutable()->solver_options_ = const_cast< ::cartographer::common::proto::CeresSolverOptions*>(
      ::cartographer::common::proto::CeresSolverOptions::internal_default_instance());
  _PoseExtrapolatorOptions_default_instance_._instance.get_mutable()->constant_velocity_ = const_cast< ::cartographer::mapping::proto::ConstantVelocityPoseExtrapolatorOptions*>(
      ::cartographer::mapping::proto::ConstantVelocityPoseExtrapolatorOptions::internal_default_instance());
  _PoseExtrapolatorOptions_default_instance_._instance.get_mutable()->imu_based_ = const_cast< ::cartographer::mapping::proto::ImuBasedPoseExtrapolatorOptions*>(
