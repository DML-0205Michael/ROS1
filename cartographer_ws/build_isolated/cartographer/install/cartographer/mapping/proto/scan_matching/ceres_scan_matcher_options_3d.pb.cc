...
void TableStruct::InitDefaultsImpl() {
  ...
  ::google::protobuf::internal::OnShutdownDestroyMessage(
      &_CeresScanMatcherOptions3D_default_instance_);_CeresScanMatcherOptions3D_default_instance_._instance.get_mutable()->ceres_solver_options_ = const_cast< ::cartographer::common::proto::CeresSolverOptions*>(
...
const ::cartographer::mapping::scan_matching::proto::IntensityCostFunctionOptions& CeresScanMatcherOptions3D::intensity_cost_function_options(int index) const {
...
::cartographer::mapping::scan_matching::proto::IntensityCostFunctionOptions* CeresScanMatcherOptions3D::mutable_intensity_cost_function_options(int index) {
...
::cartographer::mapping::scan_matching::proto::IntensityCostFunctionOptions* CeresScanMatcherOptions3D::add_intensity_cost_function_options() {
