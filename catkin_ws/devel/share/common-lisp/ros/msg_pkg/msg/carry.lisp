...
(cl:defmethod cl:initialize-instance :after ((m <carry>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'carry)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name msg_pkg-msg:<carry> is deprecated: use msg_pkg-msg:carry instead.")))

(cl:ensure-generic-function 'grade-val :lambda-list '(m))
(cl:defmethod grade-val ((m <carry>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader msg_pkg-msg:grade-val is deprecated.  Use msg_pkg-msg:grade instead.")
  (grade m))

(cl:ensure-generic-function 'star-val :lambda-list '(m))
(cl:defmethod star-val ((m <carry>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader msg_pkg-msg:star-val is deprecated.  Use msg_pkg-msg:star instead.")
  (star m))
